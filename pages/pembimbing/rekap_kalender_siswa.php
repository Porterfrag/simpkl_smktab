...
<style>
    ...
    .status-badge { display: block; padding: 4px 6px; border-radius: 4px; text-align: center; color: white; font-size: 0.75rem; font-weight: 600; margin-top: 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
<h2 class="mb-4">Kalender Absensi: <?php echo htmlspecialchars($nama_siswa); ?></h2>
